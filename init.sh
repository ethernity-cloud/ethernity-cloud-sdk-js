...
PS3="Select an option (default is Ethernity): "
options=("Ethernity (best effort)" "Custom IPFS") #"Pinata" "Infura" have free tiers
default_option="Ethernity (best effort)"
...
if [ "$ipfs_service" == "Ethernity (best effort)" ]; then
    echo "Using the Ethernity IPFS service endpoint."
