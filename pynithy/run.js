...
// Mirrors Python extract_scone_hash: pick the first 64-hex token in the output.
...
// Read the MRENCLAVE signed at build time (baked into the image as
// /signed_mrenclave.txt on mainnet). Mirrors Python extract_signed_mrenclave.
...
const main = async () => {
    ...
    // The runtime enclave measured just above (SCONE_HASH) MUST match the
